...
<head>
    ...
    <title>Police Diary -Admin Dashboard</title>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="">
                        <a href="/stations"> <i class="menu-icon fa fa-tasks"></i>Stations</a>

                    </li>

                    <li class="">
                        <a href="/police"> <i class="menu-icon fa fa-users"></i>Police</a>

                    </li>
                    <li class="">
                        <a href="/admin/users"> <i class="menu-icon fa fa-users"></i>Users</a>
